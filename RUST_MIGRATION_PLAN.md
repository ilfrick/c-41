...
| Unit tests passing | **404** |
| IOP `.rs` files | 93 (one per C IOP) |
| Shared modules | `color`, `math`, `raw`, `geometry` |
| Last patch | `Phase 2z+74` (highlights LCH reconstruction — hlreconstruct/lch.c Bayer + X-Trans loops ported) |
...
| `highlights` | 4 (+28 in hlreconstruct/) | highlights.c: `interpolate_color_xtrans` / `interpolate_color` CFA inpaint. hlreconstruct/: lch.c done (0); remaining laplacian.c 4, opposed.c 9, segbased.c 13, segmentation.c 2 |
