...
| Unit tests passing | **409** |
| IOP `.rs` files | 93 (one per C IOP) |
| Shared modules | `color`, `math`, `raw`, `geometry` |
| Last patch | `Phase 2z+75` (highlights opposed reconstruction — all 9 hlreconstruct/opposed.c loops ported) |
...
| `highlights` | 4 (+19 in hlreconstruct/) | highlights.c: `interpolate_color_xtrans` / `interpolate_color` CFA inpaint. hlreconstruct/: lch.c + opposed.c done (0); remaining laplacian.c 4, segbased.c 13, segmentation.c 2 |
