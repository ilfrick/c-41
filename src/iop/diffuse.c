                                      ...
                                      const float strength)
{
  ...
  // Anisotropic diffusion kernel -- ported to Rust (darkroom_diffuse_heat_pde).
  darkroom_diffuse_heat_pde(high_freq, low_freq, mask, has_mask, output, width, height,
                            anisotropy, (const int *)isotropy_type, regularization,
                            variance_threshold, current_radius_square, mult, ABCD, strength);
}
